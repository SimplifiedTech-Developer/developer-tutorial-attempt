...
if (!dojo._hasResource["dojox.atom.io.model"]) {
    ...
    dojo.declare("dojox.atom.io.model.Node", null, {
        constructor: function (_39, _3a, _3b, _3c, _3d) {
            this.name_space = _39;
            this.name = _3a;
            this.attributes = [];
            if (_3b) {
    ...
    dojo.declare("dojox.atom.io.model.Category", dojox.atom.io.model.Node, {
        constructor: function (_88, _89, _8a) {
            this.scheme = _88;
            this.term = _89;
            this.label = _8a;
    ...
    dojo.declare("dojox.atom.io.model.Content", dojox.atom.io.model.Node, {
        constructor: function (_8d, _8e, src, _90, _91) {
            this.tagName = _8d;
            this.value = _8e;
            this.src = src;
            this.type = _90;
    ...
    dojo.declare("dojox.atom.io.model.Link", dojox.atom.io.model.Node, {
        constructor: function (_96, rel, _98, _99, _9a) {
            this.href = _96;
            this.hrefLang = _98;
            this.rel = rel;
            this.title = _99;
    ...
    dojo.declare("dojox.atom.io.model.Person", dojox.atom.io.model.Node, {
        constructor: function (_9d, _9e, _9f, uri) {
            this.author = "author";
    ...
    dojo.declare("dojox.atom.io.model.Generator", dojox.atom.io.model.Node, {
        constructor: function (uri, _aa, _ab) {
            this.uri = uri;
            this.version = _aa;
            this.value = _ab;
        }, _postBuild: function () {
