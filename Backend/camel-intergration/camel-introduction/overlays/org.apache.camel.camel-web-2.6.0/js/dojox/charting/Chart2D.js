...
if (!dojo._hasResource["dojox.charting.Chart2D"]) {
    ...
    (function () {
        var df = dojox.lang.functional, dc = dojox.charting, _3 = df.lambda("item.clear()"),
            _4 = df.lambda("item.purgeGroup()"), _5 = df.lambda("item.destroy()"), _6 = df.lambda("item.dirty = false"),
            _7 = df.lambda("item.dirty = true");
        dojo.declare("dojox.charting.Chart2D", null, {
            constructor: function (_8, _9) {
                if (!_9) {
                    _9 = {};
                }
                ...
                if (_4b) {
                    this.surface.createRect({
                        x: _47.l,
                        y: _47.t,
                        width: dim.width - _47.l - _47.r,
                        height: dim.height - _47.t - _47.b
                    }).setFill(_4b);
                }
                if (_4c) {
                    this.surface.createRect({
                        x: _47.l,
                        y: _47.t,
                        width: dim.width - _47.l - _47.r - 1,
                        height: dim.height - _47.t - _47.b - 1
                    }).setStroke(_4c);
                }
