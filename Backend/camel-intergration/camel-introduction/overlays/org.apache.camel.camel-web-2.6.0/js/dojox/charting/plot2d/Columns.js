    ...
    (function () {
        ...
        dojo.declare("dojox.charting.plot2d.Columns", dojox.charting.plot2d.Base, {
            ...
            render: function (_9, _a) {
                ...
                var t = this.chart.theme, _e, _f, _10, f, gap, _13,
                    ht = this._hScaler.scaler.getTransformerFromModel(this._hScaler),
                    vt = this._vScaler.scaler.getTransformerFromModel(this._vScaler),
                    _16 = Math.max(0, this._vScaler.bounds.lower), _17 = vt(_16), _18 = this.events();
                ...
                for (var i = this.series.length - 1; i >= 0; --i) {
                    ...
                    for (var j = 0; j < run.data.length; ++j) {
                        ...
                        if (_13 >= 1 && h >= 1) {
                            var _20 = {
                                x: _a.l + ht(j + 0.5) + gap,
                                y: _9.height - _a.b - (v > _16 ? vv : _17),
                                width: _13,
                                height: h
                            }, _21 = s.createRect(_20).setFill(_10).setStroke(_f);
