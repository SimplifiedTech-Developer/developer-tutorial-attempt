    ...
    (function () {
        ...
        dojo.declare("dojox.charting.plot2d.Grid", dojox.charting.Element, {
            defaultParams: {
                ...
                hStripes: "none",
                vStripes: "none"
            }, optionalParams: {}, constructor: function (_2, _3) {
                ...
                try {
                    var _b = this._vAxis.getScaler(), vt = _b.scaler.getTransformerFromModel(_b),
                        _d = this._vAxis.getTicks();
                ...
                try {
                    var _12 = this._hAxis.getScaler(), ht = _12.scaler.getTransformerFromModel(_12),
                        _d = this._hAxis.getTicks();
