    ...
    (function () {
        ...
        dojo.declare("dojox.charting.plot2d.StackedColumns", dojox.charting.plot2d.Columns, {
            calculateAxes: function (_4) {
                ...
                var t = this.chart.theme, _10, _11, _12, f, gap, _15,
                    ht = this._hScaler.scaler.getTransformerFromModel(this._hScaler),
                    vt = this._vScaler.scaler.getTransformerFromModel(this._vScaler), _18 = this.events();
                ...
                for (var i = this.series.length - 1; i >= 0; --i) {
                    ...
                    for (var j = 0; j < _8.length; ++j) {
                        var v = _8[j], _19 = vt(v);
                        if (_15 >= 1 && _19 >= 1) {
                            var _1a = s.createRect({
                                x: _7.l + ht(j + 0.5) + gap,
                                y: _6.height - _7.b - vt(v),
                                width: _15,
                                height: _19
                            }).setFill(_12).setStroke(_11);
