    ...
    (function () {
        ...
        dojo.declare("dojox.charting.plot3d.Bars", dojox.charting.plot3d.Base, {
            constructor: function (_7, _8, _9) {
                ...
                var _e = this.width / this.data.length, _f = 0,
                    _10 = this.depth == "auto" ? _e - 2 * this.gap : this.depth,
                    _11 = this.height / _1(this.data, Math.max);
                if (!_d) {
                    _d = _c.view;
                }
                for (var i = 0; i < this.data.length; ++i, _f += _e) {
                    _d.createCube({
                        bottom: {x: _f + this.gap, y: 0, z: 0},
                        top: {x: _f + _e - this.gap, y: this.data[i] * _11, z: _10}
