...
if (!dojo._hasResource["dojox.charting.themes.PlotKit.orange"]) {
    ...
    (function () {
        ...
        _1.themes.PlotKit.orange = new _1.Theme({
            chart: {stroke: null, fill: "white"},
            plotarea: {stroke: null, fill: "#f5eee6"},
            axis: {
            ...
            marker: {stroke: {width: 2}, fill: "#333", font: "normal normal normal 7pt Tahoma", fontColor: "#000"},
            colors: []
        });
