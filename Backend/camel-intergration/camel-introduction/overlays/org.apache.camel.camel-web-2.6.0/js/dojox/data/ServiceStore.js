...
if (!dojo._hasResource["dojox.data.ServiceStore"]) {
    ...
    dojo.declare("dojox.data.ServiceStore", dojox.data.ClientFilter, {
        constructor: function (_1) {
            ...
            var _1d = _17.length;
            return {
                totalCount: _18.request.count == _1d ? (_18.request.start || 0) + _1d * this.estimateCountFactor : _1d,
                items: _17
            };
        }, close: function (_1e) {
            ...
            _22.addCallback(function (_23) {
                if (_1f.clientFetch) {
                    _23 = _20.clientSideFetch({
                        query: _1f.clientFetch,
                        sort: _1f.sort,
                        start: _1f.start,
                        count: _1f.count
                    }, _23);
