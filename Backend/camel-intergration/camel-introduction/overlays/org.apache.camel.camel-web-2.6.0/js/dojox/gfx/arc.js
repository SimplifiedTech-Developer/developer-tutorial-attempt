...
if (!dojo._hasResource["dojox.gfx.arc"]) {
    ...
    (function () {
        var m = dojox.gfx.matrix, _2 = function (_3) {
            var _4 = Math.cos(_3), _5 = Math.sin(_3),
                p2 = {x: _4 + (4 / 3) * (1 - _4), y: _5 - (4 / 3) * _4 * (1 - _4) / _5};
        ...
        dojo.mixin(dojox.gfx.arc, {
            unitArcAsBezier: _2, curvePI4: _b, arcAsBezier: function (_c, rx, ry, _f, _10, _11, x, y) {
                _10 = Boolean(_10);
                _11 = Boolean(_11);
                var _14 = m._degToRad(_f), rx2 = rx * rx, ry2 = ry * ry,
                    pa = m.multiplyPoint(m.rotate(-_14), {x: (_c.x - x) / 2, y: (_c.y - y) / 2}), _18 = pa.x * pa.x,
                    _19 = pa.y * pa.y, c1 = Math.sqrt((rx2 * ry2 - rx2 * _19 - ry2 * _18) / (rx2 * _19 + ry2 * _18));
                if (isNaN(c1)) {
                    c1 = 0;
                }
                ...
                var _1e = m.invert(_1d), sp = m.multiplyPoint(_1e, _c), ep = m.multiplyPoint(_1e, x, y),
                    _21 = Math.atan2(sp.y, sp.x), _22 = Math.atan2(ep.y, ep.x), _23 = _21 - _22;
                if (_11) {
                    _23 = -_23;
                }
                if (_23 < 0) {
