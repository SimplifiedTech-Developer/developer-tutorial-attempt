...
if (!dojo._hasResource["dojox.gfx.svg"]) {
    ...
    dojo.extend(dojox.gfx.Shape, {
        setFill: function (_2) {
            ...
            this.fillStyle = f;
            var _11 = this._getParentSurface(), _12 = _11.defNode, _13 = this.rawNode.getAttribute("fill"),
                ref = dojox.gfx.svg.getRef(_13);
            if (ref) {
                _13 = ref;
            ...
            if (_f == "pattern") {
                ...
                for (var i = 0; i < f.colors.length; ++i) {
                    var c = f.colors[i], t = document.createElementNS(_10, "stop"),
    ...
    dojo.declare("dojox.gfx.Path", dojox.gfx.path.Path, {
        _updateWithSegment: function (_34) {
    ...
    dojo.declare("dojox.gfx.TextPath", dojox.gfx.path.TextPath, {
        _updateWithSegment: function (_36) {
            ...
            var ref = r.firstChild.getAttributeNS(dojox.gfx.svg.xmlns.xlink, "href"),
                _3c = ref && dojox.gfx.svg.getRef(ref);
            if (!_3c) {
