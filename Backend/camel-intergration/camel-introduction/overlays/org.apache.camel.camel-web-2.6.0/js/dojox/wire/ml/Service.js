...
if (!dojo._hasResource["dojox.wire.ml.Service"]) {
    ...
    dojo.declare("dojox.wire.ml.RestHandler", null, {
        contentType: "text/plain", handleAs: "text", bind: function (_8, _9, _a, _b) {
            _8 = _8.toUpperCase();
            var _c = this;
            var _d = {
                url: this._getUrl(_8, _9, _b),
    ...
    dojo.declare("dojox.wire.ml.XmlHandler", dojox.wire.ml.RestHandler, {
        contentType: "text/xml", handleAs: "xml", _getContent: function (_1d, _1e) {
            var _1f = null;
            if (_1d == "POST" || _1d == "PUT") {
                var p = _1e[0];
                if (p) {
    ...
    dojo.declare("dojox.wire.ml.JsonHandler", dojox.wire.ml.RestHandler, {
        contentType: "text/json", handleAs: "json", headers: {"Accept": "*/json"}, _getContent: function (_24, _25) {
            var _26 = null;
            if (_24 == "POST" || _24 == "PUT") {
