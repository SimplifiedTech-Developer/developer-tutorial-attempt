...
if (!dojo._hasResource["dojo._base.query"]) {
    ...
    (function (ns) {
        var _7 = /((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^[\]]*\]|[^[\]]+)+\]|\\.|[^ >+~,(\[]+)+|[>+~])(\s*,\s*)?/g,
            _8 = 0, _9 = Object.prototype.toString;
        var _a = function (_b, _c, _d, _e) {
            ...
            if (_f.length > 1 && _17.match.POS.exec(_b)) {
                ...
                var ret = _e ? {
                    expr: _f.pop(),
                    set: _1e(_e)
                } : _a.find(_f.pop(), _f.length === 1 && _c.parentNode ? _c.parentNode : _c);
        ...
        var _17 = _a.selectors = {
            ...
            preFilter: {
                CLASS: function (_5e, _5f, _60, _61, not) {
                    _5e = " " + _5e[1].replace(/\\/g, "") + " ";
                    for (var i = 0; _5f[i]; i++) {
