    ...
    (function () {
        ...
        dojo.declare("dojox.charting.action2d.Shake", dojox.charting.action2d.Base, {
            ...
            process: function (o) {
                ...
                var _8 = o.run.name, _9 = o.index, _a = [], _b,
                    _c = o.type == "onmouseover" ? this.shiftX : -this.shiftX,
                    _d = o.type == "onmouseover" ? this.shiftY : -this.shiftY;
                if (_8 in this.anim) {
                    _b = this.anim[_8][_9];
                } else {
                    this.anim[_8] = {};
