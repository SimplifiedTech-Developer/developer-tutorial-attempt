    ...
    (function () {
        ...
        dojo.declare("dojox.charting.axis2d.Default", dojox.charting.axis2d.Base, {
            ...
            calculate: function (_b, _c, _d, _e) {
                ...
                var _f = 0, ta = this.chart.theme.axis, _11 = "font" in this.opt ? this.opt.font : ta.font,
                    _12 = _11 ? g.normalizedLength(g.splitFontString(_11).size) : 0;
                if (this.vertical) {
                    if (_12) {
                        _f = _12 + _6;
                    }
                    ...
                    if (_12) {
                        ...
                        if (this.opt.labelFunc && this.opt.maxLabelSize) {
                            ...
                            if (this.labels) {
                                ...
                                var _16 = Math.ceil(Math.log(Math.max(Math.abs(this.scaler.bounds.from), Math.abs(this.scaler.bounds.to))) / Math.LN10),
                                    t = [];
            ...
            getOffsets: function () {
                var _19 = {l: 0, r: 0, t: 0, b: 0}, _1a, a, b, c, d, gtb = dojox.gfx._base._getTextBox,
                    gl = dc.scaler.common.getNumericLabel, _21 = 0, ta = this.chart.theme.axis,
                    _23 = "font" in this.opt ? this.opt.font : ta.font,
                    _24 = "majorTick" in this.opt ? this.opt.majorTick : ta.majorTick,
                    _25 = "minorTick" in this.opt ? this.opt.minorTick : ta.minorTick,
            ...
            render: function (dim, _2b) {
                ...
                var _2c, _2d, _2e, _2f, _30, _31, ta = this.chart.theme.axis,
                    _33 = "stroke" in this.opt ? this.opt.stroke : ta.stroke,
                    _34 = "majorTick" in this.opt ? this.opt.majorTick : ta.majorTick,
                    _35 = "minorTick" in this.opt ? this.opt.minorTick : ta.minorTick,
                    _36 = "microTick" in this.opt ? this.opt.microTick : ta.minorTick,
                    _37 = "font" in this.opt ? this.opt.font : ta.font,
                    _38 = "fontColor" in this.opt ? this.opt.fontColor : ta.fontColor,
                    _39 = Math.max(_34.length, _35.length),
                    _3a = _37 ? g.normalizedLength(g.splitFontString(_37).size) : 0;
                if (this.vertical) {
                ...
                this.cleanGroup();
                try {
                    var s = this.group, c = this.scaler, t = this.ticks, _3e,
                        f = _5.getTransformerFromModel(this.scaler), _40 = dojox.gfx.renderer == "canvas",
                        _41 = _40 || this.opt.htmlLabels && !dojo.isIE && !dojo.isOpera ? "html" : "gfx",
                        dx = _2f.x * _34.length, dy = _2f.y * _34.length;
