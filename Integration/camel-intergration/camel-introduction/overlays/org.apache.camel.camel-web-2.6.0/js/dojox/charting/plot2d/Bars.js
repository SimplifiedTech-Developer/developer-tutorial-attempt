    ...
    (function () {
        ...
        dojo.declare("dojox.charting.plot2d.Bars", dojox.charting.plot2d.Base, {
            ...
            render: function (_a, _b) {
                ...
                var t = this.chart.theme, _f, _10, _11, f, gap, _14,
                    ht = this._hScaler.scaler.getTransformerFromModel(this._hScaler),
                    vt = this._vScaler.scaler.getTransformerFromModel(this._vScaler),
                    _17 = Math.max(0, this._hScaler.bounds.lower), _18 = ht(_17), _19 = this.events();
                ...
                for (var i = this.series.length - 1; i >= 0; --i) {
                    ...
                    for (var j = 0; j < run.data.length; ++j) {
                        ...
                        if (w >= 1 && _14 >= 1) {
                            var _21 = s.createRect({
                                x: _b.l + (v < _17 ? hv : _18),
                                y: _a.height - _b.b - vt(j + 1.5) + gap,
                                width: w,
                                height: _14
                            }).setFill(_11).setStroke(_10);
