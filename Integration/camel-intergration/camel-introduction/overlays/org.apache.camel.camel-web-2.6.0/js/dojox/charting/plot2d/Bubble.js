...
if (!dojo._hasResource["dojox.charting.plot2d.Bubble"]) {
    ...
    (function () {
        var df = dojox.lang.functional, du = dojox.lang.utils, dc = dojox.charting.plot2d.common,
            _4 = df.lambda("item.purgeGroup()");
        dojo.declare("dojox.charting.plot2d.Bubble", dojox.charting.plot2d.Base, {
            defaultParams: {hAxis: "x", vAxis: "y"}, optionalParams: {}, constructor: function (_5, _6) {
                ...
                var t = this.chart.theme, _d, _e, _f, _10, _11,
                    ht = this._hScaler.scaler.getTransformerFromModel(this._hScaler),
                    vt = this._vScaler.scaler.getTransformerFromModel(this._vScaler), _14 = this.events();
                this.resetEvents();
                    ...
                    if (_14) {
                        dojo.forEach(_1a, function (s, i) {
                            var o = {
                                ...
                                shape: s,
                                outline: _1b && _1b[i] || null,
                                shadow: _1c && _1c[i] || null,
                                x: run.data[i].x,
                                y: run.data[i].y,
                                r: run.data[i].size / 2,
                                cx: _17[i].x,
