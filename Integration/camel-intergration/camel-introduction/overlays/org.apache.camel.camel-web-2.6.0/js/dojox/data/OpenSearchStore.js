...
if (!dojo._hasResource["dojox.data.OpenSearchStore"]) {
    ...
    dojo.declare("dojox.data.OpenSearchStore", null, {
        ...
        _createSearchUrl: function (_1d) {
            ...
            dojo.forEach([{"name": "count", "test": _1d.count, "def": "10"}, {
                "name": "startIndex",
                "test": _1d.start,
            ...
            }, {"name": "language", "test": _1d.language, "def": "*"}, {
                "name": "inputEncoding",
                "test": _1d.inputEncoding,
                "def": "UTF-8"
            }, {"name": "outputEncoding", "test": _1d.outputEncoding, "def": "UTF-8"}], function (_21) {
