...
if (!dojo._hasResource["dojox.fx.split"]) {
    ...
    dojo.mixin(dojox.fx, {
        _split: function (_1) {
            ...
            var _2 = _1.node = dojo.byId(_1.node), _3 = dojo.coords(_2, true), _4 = Math.ceil(_3.h / _1.rows),
                _5 = Math.ceil(_3.w / _1.columns), _6 = dojo.create(_2.tagName), _7 = [], _8 = dojo.create(_2.tagName),
                _9;
            dojo.style(_6, {
                position: "absolute",
                padding: "0",
            ...
            _e.pieceAnimation = function (_10, x, y, _13) {
                var _14 = _13.h / _e.rows, _15 = _13.w / _e.columns, _16 = _e.distance * 2, _17 = _e.duration,
                    ps = _10.style, _19 = parseInt(ps.top), _1a = parseInt(ps.left), _1b = 0, _1c = 0, _1d = 0;
                if (_e.random) {
                ...
                var _1f = ((_13.h - _14) / 2 - _14 * y), _20 = ((_13.w - _15) / 2 - _15 * x),
                    _21 = Math.sqrt(Math.pow(_20, 2) + Math.pow(_1f, 2)), _22 = parseInt(_19 - _1f * _16 + _21 * _1d),
                    _23 = parseInt(_1a - _20 * _16 + _21 * _1c);
                var _24 = dojo.animateProperty({
                    node: _10,
                    duration: _17,
                    delay: _1b,
                    easing: (_e.easing || (_e.unhide ? dojo.fx.easing.sinOut : dojo.fx.easing.circOut)),
                    beforeBegin: (_e.unhide ? function () {
                        if (_e.fade) {
                    ...
                    properties: {
                        top: (_e.unhide ? {start: _22, end: _19} : {start: _19, end: _22}),
                        left: (_e.unhide ? {start: _23, end: _1a} : {start: _1a, end: _23})
                    }
                });
                if (_e.fade) {
                    var _25 = dojo.animateProperty({
                        node: _10,
                        duration: _17,
                        delay: _1b,
                        easing: (_e.fadeEasing || dojo.fx.easing.quadOut),
                        properties: {opacity: (_e.unhide ? {start: "0", end: "1"} : {start: "1", end: "0"})}
                    });
            ...
            _28.pieceAnimation = function (_2c, x, y, _2f) {
                var _30 = Math.random() * (_28.rows + _28.columns) * _28.interval, ps = _2c.style,
                    _32 = (_28.reverseOrder || _28.distance < 0) ? ((x + y) * _28.interval) : (((_28.rows + _28.columns) - (x + y)) * _28.interval),
                    _33 = _30 * _2a + Math.max(1 - _2a, 0) * _32, _34 = {};
                if (_28.unhide) {
                ...
                var _35 = dojo.animateProperty({
                    node: _2c,
                    duration: _2b,
                    delay: _33,
                    easing: (_28.easing || (_28.unhide ? dojo.fx.easing.sinIn : dojo.fx.easing.circIn)),
                    properties: _34,
                    beforeBegin: (_28.unhide ? function () {
                        if (_28.fade) {
            ...
            _38.pieceAnimation = function (_3c, x, y, _3f) {
                var _40 = !(x % 2), _41 = !(y % 2), _42 = Math.random() * _3b,
                    _43 = (_38.reverseOrder) ? (((_38.rows + _38.columns) - (x + y)) * _38.interval) : ((x + y) * _38.interval),
                    _44 = _42 * _3a + Math.max(1 - _3a, 0) * _43, _45 = {}, ps = _3c.style;
                if (_38.fade) {
                ...
                var _47 = parseInt(ps.left), top = parseInt(ps.top), _49 = _38.distance * _3f.w,
                    _4a = _38.distance * _3f.h;
                if (_38.unhide) {
                    if (_40 == _41) {
                ...
                var _4b = dojo.animateProperty({
                    ...
                    duration: _3b,
                    delay: _44,
                    easing: (_38.easing || dojo.fx.easing.sinInOut),
                    properties: _45,
                    beforeBegin: (_38.unhide ? function () {
                        if (_38.fade) {
                            ps.opacity = "0";
                        }
                        if (_40 == _41) {
            ...
            _4e.pieceAnimation = function (_51, x, y, _54) {
                var _55 = _54.h / _4e.rows, _56 = _54.w / _4e.columns, _57 = !(x % 2), _58 = !(y % 2),
                    _59 = Math.random() * _50,
                    _5a = (_4e.interval < 0) ? (((_4e.rows + _4e.columns) - (x + y)) * _4e.interval * -1) : ((x + y) * _4e.interval),
                    _5b = _59 * _4e.random + Math.max(1 - _4e.random, 0) * _5a, _5c = {}, ps = _51.style;
                if (_4e.fade) {
                ...
                if (_57) {
                    if (_58) {
                        _5c.top = _4e.unhide ? {start: top + _55 * _4e.distance, end: top} : {
                            start: top,
                            end: top + _55 * _4e.distance
                        };
                    } else {
                        _5c.left = _4e.unhide ? {start: _5e + _56 * _4e.distance, end: _5e} : {
                            start: _5e,
                            end: _5e + _56 * _4e.distance
                        };
                    }
                }
                if (_57 != _58) {
                    _5c.width = _4e.unhide ? {start: _56 * (1 - _4e.distance), end: _56} : {
                        start: _56,
                        end: _56 * (1 - _4e.distance)
                    };
                } else {
                    _5c.height = _4e.unhide ? {start: _55 * (1 - _4e.distance), end: _55} : {
                        start: _55,
                        end: _55 * (1 - _4e.distance)
                    };
                }
            ...
            _63.pieceAnimation = function (_67, x, y, _6a) {
                var _6b = Math.random() * _63.duration,
                    _6c = (_63.reverseOrder) ? (((_63.rows + _63.columns) - (x + y)) * Math.abs(_63.interval)) : ((x + y) * _63.interval),
                    _6d = _6b * _65 + Math.max(1 - _65, 0) * _6c, _6e = dojo.animateProperty({
                        node: _67,
                        duration: _66,
                        delay: _6d,
                        easing: (_63.easing || dojo.fx.easing.sinInOut),
                        properties: {opacity: (_63.unhide ? {start: "0", end: "1"} : {start: "1", end: "0"})},
                        beforeBegin: (_63.unhide ? function () {
