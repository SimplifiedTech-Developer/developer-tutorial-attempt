...
if (!dojo._hasResource["dojox.gfx.decompose"]) {
    ...
    (function () {
        ...
        var _f = function (_10) {
            var M = m.normalize(_10), b = -M.xx - M.yy, c = M.xx * M.yy - M.xy * M.yx, d = Math.sqrt(b * b - 4 * c),
                l1 = -(b + (b < 0 ? -d : d)) / 2, l2 = c / l1, vx1 = M.xy / (l1 - M.xx), vy1 = 1,
        ...
        var _1d = function (M, _1f) {
            var _20 = _d(M), a = _1f.angle1 = (Math.atan2(M.yx, M.yy) + Math.atan2(-_20 * M.xy, _20 * M.xx)) / 2,
        ...
        var _24 = function (M, _26) {
            var _27 = _d(M), a = _26.angle2 = (Math.atan2(_27 * M.yx, _27 * M.xx) + Math.atan2(-M.xy, M.yy)) / 2,
                cos = Math.cos(a), sin = Math.sin(a);
        ...
        dojox.gfx.decompose = function (_2b) {
            ...
            var MT = _a(M), u = _f([M, MT]), v = _f([MT, M]),
