    ...
    dojo.declare("dojox.gfx.shape.Line", dojox.gfx.Shape, {
        constructor: function (_2e) {
            ...
            if (!this.bbox) {
                var _2f = this.shape;
                this.bbox = {
                    x: Math.min(_2f.x1, _2f.x2),
                    y: Math.min(_2f.y1, _2f.y2),
                    width: Math.abs(_2f.x2 - _2f.x1),
                    height: Math.abs(_2f.y2 - _2f.y1)
                };
            }
            return this.bbox;
        }
