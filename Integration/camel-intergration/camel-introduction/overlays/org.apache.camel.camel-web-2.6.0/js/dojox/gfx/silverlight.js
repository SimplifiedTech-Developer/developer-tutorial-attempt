...
if (!dojo._hasResource["dojox.gfx.silverlight"]) {
            ...
            if (typeof (_5) == "object" && "type" in _5) {
                switch (_5.type) {
                    ...
                    case "radial":
                        ...
                        var _c = p.createFromXaml("<RadialGradientBrush/>"),
    ...
    dojo.declare("dojox.gfx.Path", dojox.gfx.path.Path, {
        _updateWithSegment: function (_55) {
    ...
    dojo.declare("dojox.gfx.TextPath", dojox.gfx.path.TextPath, {
        _updateWithSegment: function (_59) {
    ...
    (function () {
        ...
        var _86 = {
            onclick: {name: "MouseLeftButtonUp", fix: _7b},
            onmouseenter: {name: "MouseEnter", fix: _7b},
            onmouseleave: {name: "MouseLeave", fix: _7b},
            onmouseover: {name: "MouseEnter", fix: _7b},
            onmouseout: {name: "MouseLeave", fix: _7b},
            onmousedown: {name: "MouseLeftButtonDown", fix: _7b},
            onmouseup: {name: "MouseLeftButtonUp", fix: _7b},
            onmousemove: {name: "MouseMove", fix: _7b},
            onkeydown: {name: "KeyDown", fix: _82},
            onkeyup: {name: "KeyUp", fix: _82}
        };
        var _87 = {
            connect: function (_88, _89, _8a) {
                var _8b, n = _88 in _86 ? _86[_88] : {
                    name: _88, fix: function () {
                        return {};
                    }
                };
