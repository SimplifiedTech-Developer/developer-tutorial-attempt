...
if (!dojo._hasResource["dojox.image.LightboxNano"]) {
    ...
    (function (d) {
        var _2 = function () {
            var _3 = d.global, _4 = d.doc, w = 0, h = 0, de = _4.documentElement, _8 = de.clientWidth,
                _9 = de.clientHeight, _a = d._docScroll();
            if (d.isMozilla) {
        ...
        d.declare("dojox.image.LightboxNano", null, {
            ...
            _load: function (e) {
                ...
                if (!_1b._loading) {
                    _1b._loading = true;
                    _1b._reset();
                    var n = d.query("img", _1b._node)[0], a = d._abs(n, true), c = d.contentBox(n),
                        b = d._getBorderExtents(n), i = d.doc.createElement("img"), ln = _1b._loadingNode;
                    if (ln == null) {
            ...
            _show: function () {
                var _23 = this, vp = _2(), w = _23._img.width, h = _23._img.height, vpw = parseInt((vp.w - 20) * 0.9),
                    vph = parseInt((vp.h - 20) * 0.9), dd = d.doc, bg = dd.createElement("div"), ln = _23._loadingNode;
                if (_23._loadingNode) {
                    _23._hideLoading();
                }
            ...
            _anim: function (_33, _34, _35) {
                return d.animateProperty({
                    ...
                    properties: _34,
                    onEnd: _35 ? d.hitch(this, _35) : null
                });
            }
        });
    })(dojo);
