...
if (!dojo._hasResource["dojox.lang.functional.tailrec"]) {
    ...
    (function () {
        ...
        df.tailrec = function (_4, _5, _6) {
            ...
            var _11 = df.keys(_d), _12 = df.keys(_e),
                f = new Function([], "var _x=arguments,_t=_x.callee,_c=_t.c,_b=_t.b".concat(_11.length ? "," + _11.join(",") : "", _12.length ? ",_t=_x.callee," + _12.join(",") : t ? ",_t=_x.callee" : "", ";for(;!", cs, ";_x=", bs, ");return ", ts));
            if (c) {
                f.c = c;
            }
            if (t) {
