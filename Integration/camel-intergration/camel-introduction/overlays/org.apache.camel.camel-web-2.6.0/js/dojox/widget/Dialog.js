...
if (!dojo._hasResource["dojox.widget.Dialog"]) {
    ...
    dojo.declare("dojox.widget.Dialog", dijit.Dialog, {
        ...
        _setSize: function () {
            ...
            return this._displaysize = {
                w: _5 ? tc.scrollWidth : this.dimensions[0],
                h: _5 ? tc.scrollHeight : this.dimensions[1]
            };
        },
        show: function () {
            this._setSize();
        ...
        _handleNav: function (e) {
            var _8 = "_navOut", _9 = "_navIn", _a = (e.type == "mouseout" ? _9 : _8),
                _b = (e.type == "mouseout" ? _8 : _9);
            this[_a].stop();
            this[_b].play();
        },
        _position: function () {
