...
if (!dojo._hasResource["dojo._base.html"]) {
    ...
    (function () {
        ...
        dojo._getBorderExtents = function (n, _4d) {
            var ne = "none", s = _4d || gcs(n), bl = (s.borderLeftStyle != ne ? px(n, s.borderLeftWidth) : 0),
        ...
        dojo._getMarginExtents = function (n, _58) {
            var s = _58 || gcs(n), l = px(n, s.marginLeft), t = px(n, s.marginTop), r = px(n, s.marginRight),
        ...
        dojo._getContentBox = function (_69, _6a) {
            var s = _6a || gcs(_69), pe = d._getPadExtents(_69, s), be = d._getBorderExtents(_69, s),
                w = _69.clientWidth, h;
            if (!w) {
        ...
        var _c3 = {}, _c4 = 0, _c5 = dojo._scopeName + "attrid",
            _c6 = {col: 1, colgroup: 1, table: 1, tbody: 1, tfoot: 1, thead: 1, tr: 1, title: 1};
        ...
        var _da = {
            ...
            col: ["table", "colgroup"],
            li: ["ul"]
        }, _db = /<\s*([\w\:]+)/, _dc = {}, _dd = 0, _de = "__" + d._scopeName + "ToDomId";
        for (var _df in _da) {
            var tw = _da[_df];
