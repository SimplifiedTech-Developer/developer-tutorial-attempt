    ...
    dojo.declare("dojo.dnd.Avatar", null, {
        constructor: function (_1) {
            ...
            var a = dojo.create("table", {
                ...
                }), b = dojo.create("tbody", null, a), tr = dojo.create("tr", null, b),
                td = dojo.create("td", {innerHTML: this._generateText()}, tr),
                k = Math.min(5, this.manager.nodes.length), i = 0, _8 = this.manager.source, _9;
