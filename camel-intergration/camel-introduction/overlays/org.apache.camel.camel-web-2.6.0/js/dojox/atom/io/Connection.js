...
if (!dojo._hasResource["dojox.atom.io.Connection"]) {
    ...
    dojo.declare("dojox.atom.io.Connection", null, {
        constructor: function (_1, _2) {
            ...
            var _17 = {
                url: _f, handleAs: "xml", sync: this.sync, preventCache: this.preventCache, load: function (_18, _19) {
                    var _1a = null;
                    var _1b = _18;
                    var _1c;
                    if (_1b) {
            ...
            var _44 = {
                ...
                sync: this.sync,
                preventCache: this.preventCache,
                postData: _3a.toString(true),
                load: function (_45, _46) {
