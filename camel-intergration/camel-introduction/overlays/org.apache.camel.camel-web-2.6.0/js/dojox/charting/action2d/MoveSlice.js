    ...
    (function () {
        ...
        dojo.declare("dojox.charting.action2d.MoveSlice", dojox.charting.action2d.Base, {
            ...
            process: function (o) {
                ...
                var _a = o.index, _b, _c, _d, _e, _f = (this.angles[_a] + this.angles[_a + 1]) / 2,
                    _10 = m.rotateAt(-_f, o.cx, o.cy), _11 = m.rotateAt(_f, o.cx, o.cy);
                _b = this.anim[_a];
                if (_b) {
                    _b.action.stop(true);
                } else {
                ...
                _b.action = dojox.gfx.fx.animateTransform({
                    shape: o.shape,
                    duration: this.duration,
                    easing: this.easing,
                    transform: [_11, {name: "translate", start: [_d, 0], end: [_e, 0]}, {
                        name: "scaleAt",
                        start: [1, o.cx, o.cy],
                        end: [_c, o.cx, o.cy]
                    }, _10]
