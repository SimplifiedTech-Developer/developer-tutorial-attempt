        ...
        dojo.declare("dojox.charting.plot2d.ClusteredColumns", dojox.charting.plot2d.Columns, {
            render: function (_4, _5) {
                ...
                var t = this.chart.theme, _9, _a, _b, f, _d, _e, _f,
                    ...
                    _12 = Math.max(0, this._vScaler.bounds.lower), _13 = vt(_12), _14 = this.events();
                ...
                for (var i = 0; i < this.series.length; ++i) {
                    ...
                    for (var j = 0; j < run.data.length; ++j) {
                        ...
                        if (_e >= 1 && h >= 1) {
                            var _1d = s.createRect({
                                x: _5.l + ht(j + 0.5) + _d + _17,
                                y: _4.height - _5.b - (v > _12 ? vv : _13),
                                width: _e,
                                height: h
                            }).setFill(_b).setStroke(_a);
