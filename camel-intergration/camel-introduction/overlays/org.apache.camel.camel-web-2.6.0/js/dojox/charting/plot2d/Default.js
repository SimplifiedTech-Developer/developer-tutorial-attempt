...
if (!dojo._hasResource["dojox.charting.plot2d.Default"]) {
    ...
    (function () {
        ...
        dojo.declare("dojox.charting.plot2d.Default", dojox.charting.plot2d.Base, {
            defaultParams: {hAxis: "x", vAxis: "y", lines: true, areas: false, markers: false, shadows: 0, tension: 0},
            optionalParams: {},
            ...
            render: function (_8, _9) {
                ...
                for (var i = this.series.length - 1; i >= 0; --i) {
                    ...
                    var s = run.group, _14, ht = this._hScaler.scaler.getTransformerFromModel(this._hScaler),
                    ...
                    if (this.opt.shadows && _d) {
                        var sh = this.opt.shadows, _23 = new dojo.Color([0, 0, 0, 0.3]),
                            _24 = dojo.map(_14, function (c) {
