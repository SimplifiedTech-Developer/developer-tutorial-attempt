...
if (!dojo._hasResource["dojox.charting.plot2d.Pie"]) {
    ...
    (function () {
        var df = dojox.lang.functional, du = dojox.lang.utils, dc = dojox.charting.plot2d.common,
            da = dojox.charting.axis2d.common, g = dojox.gfx;
        dojo.declare("dojox.charting.plot2d.Pie", dojox.charting.Element, {
            defaultParams: {
                ...
                labelStyle: "default",
                htmlLabels: true
            }, optionalParams: {font: "", fontColor: "", radius: 0}, constructor: function (_6, _7) {
                ...
                var rx = (dim.width - _16.l - _16.r) / 2, ry = (dim.height - _16.t - _16.b) / 2, r = Math.min(rx, ry),
                    _1d = "font" in this.opt ? this.opt.font : t.axis.font,
                    _1e = _1d ? g.normalizedLength(g.splitFontString(_1d).size) : 0,
                    _1f = "fontColor" in this.opt ? this.opt.fontColor : t.axis.fontColor, _20 = 0, _21, _22, _23, _24,
                    _25, _26, run = this.run.data, _28 = this.events();
                ...
                dojo.some(_23, function (_2f, i) {
                    ...
                    var _38 = end - _20, x1 = _2e.cx + r * Math.cos(_20), y1 = _2e.cy + r * Math.sin(_20),
                        x2 = _2e.cx + r * Math.cos(end), y2 = _2e.cy + r * Math.sin(end);
                    var _32, _33, _34;
                    if (typeof v == "object") {
                        _32 = "color" in v ? v.color : new dojo.Color(t.next("color"));
                        _33 = "fill" in v ? v.fill : dc.augmentFill(t.series.fill, _32);
                ...
                if (this.opt.labels) {
                    ...
                    dojo.some(_23, function (_3d, i) {
                        ...
                        if (_3d >= 1) {
                            var v = run[i],
                                _40 = da.createText[this.opt.htmlLabels && dojox.gfx.renderer != "vml" ? "html" : "gfx"](this.chart, s, _2e.cx, _2e.cy + _1e / 2, "middle", _24[i], _1d, (typeof v == "object" && "fontColor" in v) ? v.fontColor : _1f);
                        ...
                        var _42 = (_20 + end) / 2, x = _2e.cx + _26 * Math.cos(_42),
                            y = _2e.cy + _26 * Math.sin(_42) + _1e / 2;
