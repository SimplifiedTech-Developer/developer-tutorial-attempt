    ...
    (function () {
        ...
        dojo.declare("dojox.charting.plot2d.Stacked", dojox.charting.plot2d.Default, {
            calculateAxes: function (_4) {
                ...
                var t = this.chart.theme, _10, _11, _12, _13, _14 = this.events(),
                ...
                for (var i = this.series.length - 1; i >= 0; --i) {
                    ...
                    if (this.opt.shadows && _10) {
                        var sh = this.opt.shadows, _22 = new dojo.Color([0, 0, 0, 0.3]),
                            _23 = dojo.map(_17, function (c) {
