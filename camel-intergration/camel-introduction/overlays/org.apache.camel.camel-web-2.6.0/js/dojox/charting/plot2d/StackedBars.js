    ...
    (function () {
        ...
        dojo.declare("dojox.charting.plot2d.StackedBars", dojox.charting.plot2d.Bars, {
            calculateAxes: function (_4) {
                ...
                var t = this.chart.theme, _11, _12, _13, f, gap, _16,
                    ht = this._hScaler.scaler.getTransformerFromModel(this._hScaler),
                    vt = this._vScaler.scaler.getTransformerFromModel(this._vScaler), _19 = this.events();
                ...
                for (var i = this.series.length - 1; i >= 0; --i) {
                    ...
                    for (var j = 0; j < _9.length; ++j) {
                        var v = _9[j], _1a = ht(v);
                        if (_1a >= 1 && _16 >= 1) {
                            var _1b = s.createRect({
                                x: _8.l,
                                y: _7.height - _8.b - vt(j + 1.5) + gap,
                                width: _1a,
                                height: _16
                            }).setFill(_13).setStroke(_12);
