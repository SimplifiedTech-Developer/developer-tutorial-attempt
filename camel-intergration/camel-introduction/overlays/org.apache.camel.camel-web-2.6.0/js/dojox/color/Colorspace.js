    ...
    dojox.color.Colorspace = new (function () {
        ...
        var _7 = {
            "XYZ": {
                ...
                "Lab": function (lch) {
                    var _40 = lch.H * (Math.PI / 180), L = lch.L,
                        a = lch.C / Math.pow(Math.pow(Math.tan(_40), 2) + 1, 0.5);
        ...
        this.primaries = function (_147) {
            ...
            if (_147.whitepoint != _149.whitepoint) {
                var r = this.convert(this.adapt({
                    ...
                    adaptor: _147.adaptor,
                    source: _149.whitepoint,
                    destination: _147.whitepoint
                }), "XYZ", "xyY");
