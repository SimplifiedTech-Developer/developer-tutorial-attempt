    ...
    (function () {
        ...
        function _4(p, _6, _7) {
            ...
            dojo.forEach(p.colors, function (_9) {
                var r = (_6 == "dr") ? _9.r + _7 : _9.r, g = (_6 == "dg") ? _9.g + _7 : _9.g,
                    b = (_6 == "db") ? _9.b + _7 : _9.b, a = (_6 == "da") ? _9.a + _7 : _9.a;
                _8.colors.push(new dojox.color.Color({
        ...
        function _e(p, _10, val) {
            ...
            dojo.forEach(p.colors, function (_13) {
                var o = _13.toCmy(), c = (_10 == "dc") ? o.c + val : o.c, m = (_10 == "dm") ? o.m + val : o.m,
                    y = (_10 == "dy") ? o.y + val : o.y;
        ...
        function _18(p, _1a, val) {
            ...
            dojo.forEach(p.colors, function (_1d) {
                var o = _1d.toCmyk(), c = (_1a == "dc") ? o.c + val : o.c, m = (_1a == "dm") ? o.m + val : o.m,
                    y = (_1a == "dy") ? o.y + val : o.y, k = (_1a == "dk") ? o.b + val : o.b;
        ...
        function _23(p, _25, val) {
            ...
            dojo.forEach(p.colors, function (_28) {
                var o = _28.toHsl(), h = (_25 == "dh") ? o.h + val : o.h, s = (_25 == "ds") ? o.s + val : o.s,
                    l = (_25 == "dl") ? o.l + val : o.l;
        ...
        function _2d(p, _2f, val) {
            ...
            dojo.forEach(p.colors, function (_32) {
                var o = _32.toHsv(), h = (_2f == "dh") ? o.h + val : o.h, s = (_2f == "ds") ? o.s + val : o.s,
                    v = (_2f == "dv") ? o.v + val : o.v;
        ...
        dojo.mixin(_1.Palette, {
            generators: {
                analogous: function (_40) {
                    var _41 = _40.high || 60, low = _40.low || 18,
                        _43 = dojo.isString(_40.base) ? new dojox.color.Color(_40.base) : _40.base, hsv = _43.toHsv();
                    ...
                    var s1 = (hsv.s - 30 > 9) ? hsv.s - 30 : hsv.s + 30, s2 = hsv.s, v1 = _37(hsv.v, 20, 100),
                    ...
                    var h1 = ((hsv.h * 2) + 137 < 360) ? (hsv.h * 2) + 137 : Math.floor(hsv.h / 2) - 137,
                        s1 = Math.max(hsv.s - 10, 0), s2 = _37(hsv.s, 10, 100), s3 = Math.min(100, hsv.s + 20),
                    ...
                    var _6b = dojo.isString(_6a.base) ? new dojox.color.Color(_6a.base) : _6a.base, _6c = _6a.da || 30,
                        hsv = _6b.toHsv();
                    var _6e = ((hsv.h * 2) + 137 < 360) ? (hsv.h * 2) + 137 : Math.floor(hsv.h / 2) - 137,
                        h1 = (_6e - _6c + 360) % 360, h2 = (_6e + _6c) % 360, s1 = Math.max(hsv.s - 10, 0),
                        s2 = _37(hsv.s, 10, 100), s3 = Math.min(100, hsv.s + 20), v1 = Math.min(100, hsv.v + 30),
