    ...
    (function () {
        ...
        dojo.declare("dojox.data.ItemExplorer", dijit.Tree, {
            useSelect: false, refSelectSearchAttr: null, constructor: function (_6) {
                ...
                _36.appendChild(_37);
                var _38 = new dijit.form.ValidationTextBox({
                    name: "property",
                    value: "",
                    required: true,
                    disabled: true
                ...
                _36.appendChild(dojo.doc.createElement("br"));
                var _39 = new dijit.form.RadioButton({
                ...
                _36.appendChild(_3b);
                var _3d = new dijit.form.RadioButton({
                ...
                if (this.useSelect) {
                    var _40 = new dijit.form.FilteringSelect({
                        name: "_reference",
                        store: this.store,
                    ...
                    var _41 = new dijit.form.ValidationTextBox({
                        name: "_reference",
                        value: "",
                        promptMessage: "Enter the ID of the item to reference",
                        isValid: dojo.hitch(this, function (_42) {
                            return true;
                        })
                    }).placeAt(_3f);
                }
                    ...
                    switch (_4b.itemType) {
                        case "reference":
                            this.store.fetchItemByIdentity({
                                identity: _4b._reference, onItem: function (_59) {
                                    val = _59;
                                    _53();
                                }, onError: function () {
