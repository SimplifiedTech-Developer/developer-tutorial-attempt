...
if (!dojo._hasResource["dojox.date.IslamicDate"]) {
    ...
    dojo.declare("dojox.date.IslamicDate", null, {
        ...
        toGregorian: function () {
            ...
            var wjd = Math.floor(_16 - 0.5) + 0.5, _18 = wjd - this._GREGORIAN_EPOCH, _19 = Math.floor(_18 / 146097),
                dqc = this._mod(_18, 146097), _1b = Math.floor(dqc / 36524), _1c = this._mod(dqc, 36524),
                _1d = Math.floor(_1c / 1461), _1e = this._mod(_1c, 1461), _1f = Math.floor(_1e / 365),
                _20 = (_19 * 400) + (_1b * 100) + (_1d * 4) + _1f;
            if (!(_1b == 4 || _1f == 4)) {
                _20++;
            }
