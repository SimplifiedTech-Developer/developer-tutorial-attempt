...
if (!dojo._hasResource["dojox.editor.refactor.RichText"]) {
    ...
    dojo.declare("dojox.editor.refactor.RichText", dijit._Widget, {
        ...
        setupDefaultShortcuts: function () {
            ...
            var _27 = {
                ...
                "1": _24("formatblock", "h1"),
                "2": _24("formatblock", "h2"),
                "3": _24("formatblock", "h3"),
                "4": _24("formatblock", "h4"),
                "\\": _24("insertunorderedlist")
            };
            if (!dojo.isIE) {
                _27.Z = _24("redo");
            }
        ...
        _saveSelection: function () {
            ...
            this._savedSelection = {
                ...
                nodes: _55,
                bookmark: this._getBookmark(_55)
            };
        ...
        _qcaCache: {},
        queryCommandAvailable: function (_5e) {
        ...
        _queryCommandAvailable: function (_60) {
            ...
            function _67(_68) {
                return {
                    ie: Boolean(_68 & ie),
                    mozilla: Boolean(_68 & _62),
                    safari: Boolean(_68 & _63),
                    safari420: Boolean(_68 & _65),
                    opera: Boolean(_68 & _64)
                };
            };
            var _69 = null;
        ...
        _getBookmark: function (_9b) {
            ...
            if (_9b.length) {
                ...
                dojo.attr(_9c, {
                    isBookmark: "true",
                    bookmarkId: id,
                    style: {width: "1px", height: "1px", overflow: "hidden", border: "3px solid blue"}
                });
    ...
    (function () {
        ...
        new TRC({
            name: "fontname", tag: "span", applicationHelper: function (arg, _f5) {
