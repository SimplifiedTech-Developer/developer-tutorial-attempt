...
if (!dojo._hasResource["dojox.form.Manager"]) {
    ...
    dojo.declare("dojox.form.Manager", [dijit._Widget, dijit._Templated, dojox.form.manager._Mixin, dojox.form.manager._NodeMixin, dojox.form.manager._FormMixin, dojox.form.manager._ValueMixin, dojox.form.manager._EnableMixin, dojox.form.manager._DisplayMixin, dojox.form.manager._ClassMixin], {
        widgetsInTemplate: true, buildRendering: function () {
