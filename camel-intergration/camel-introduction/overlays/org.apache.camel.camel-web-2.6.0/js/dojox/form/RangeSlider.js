...
if (!dojo._hasResource["dojox.form.RangeSlider"]) {
    ...
    dojo.declare("dojox.form._RangeSliderMixin", null, {
        value: [0, 100], postCreate: function () {
            ...
            switch (e.keyCode) {
                ...
                case (this._descending === false ? dojo.keys.PAGE_DOWN : dojo.keys.PAGE_UP):
                    if (_a && _b) {
                        _c = Array();
                        _c[0] = {
                            "change": e.keyCode == dojo.keys.PAGE_UP ? this.pageIncrement : 1,
                            "useMaxValue": true
                        };
                        _c[1] = {
                            "change": e.keyCode == dojo.keys.PAGE_UP ? this.pageIncrement : 1,
                ...
                case (this._descending === false ? dojo.keys.PAGE_UP : dojo.keys.PAGE_DOWN):
                    if (_a && _b) {
                        _c = Array();
                        _c[0] = {
                            "change": e.keyCode == dojo.keys.PAGE_DOWN ? -this.pageIncrement : -1,
                            "useMaxValue": false
                        };
                        _c[1] = {
                            "change": e.keyCode == dojo.keys.PAGE_DOWN ? -this.pageIncrement : -1,
