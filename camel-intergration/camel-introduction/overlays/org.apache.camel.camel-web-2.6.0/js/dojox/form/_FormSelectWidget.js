...
if (!dojo._hasResource["dojox.form._FormSelectWidget"]) {
    ...
    dojo.declare("dojox.form._FormSelectWidget", dijit.form._FormValueWidget, {
        multiple: "", _multiValue: false, options: null, getOptions: function (_1) {
            ...
            if (!_2d) {
                _2d = this.options = this.srcNodeRef ? dojo.query(">", this.srcNodeRef).map(function (_2e) {
                    ...
                    return {
                        value: _2e.getAttribute("value"),
                        label: String(_2e.innerHTML),
                        selected: _2e.getAttribute("selected") || false,
                        disabled: _2e.getAttribute("disabled") || false
                    };
                }, this) : [];
            }
            if (!this.value) {
