...
if (!dojo._hasResource["dojox.fx.flip"]) {
    ...
    (function () {
        ...
        dojox.fx.flip = function (_8) {
            var _9 = dojo.create("div"), _a = _8.node = dojo.byId(_8.node), s = _a.style, _c = null, hs = null,
                pn = null, _f = _8.lightColor || "#dddddd", _10 = _8.darkColor || "#555555",
                _11 = dojo.style(_a, "backgroundColor"), _12 = _8.endColor || _11, _13 = {}, _14 = [],
                _15 = _8.duration ? _8.duration / 2 : 250, dir = _8.dir || "left", _17 = 0.9, _18 = "transparent",
                _19 = _8.whichAnim, _1a = _8.axis || "center", _1b = _8.depth;
        ...
        dojox.fx.flipCube = function (_27) {
            var _28 = [], mb = dojo.marginBox(_27.node), _2a = mb.w / 2, _2b = mb.h / 2, _2c = {
                top: {
                    pName: "height",
                    args: [{whichAnim: "first", dir: "top", shift: -_2b}, {
                        whichAnim: "last",
                        dir: "bottom",
                        shift: _2b
                    }]
                ...
                right: {
                    pName: "width",
                    args: [{whichAnim: "first", dir: "right", shift: _2a}, {
                        whichAnim: "last",
                        dir: "left",
                        shift: -_2a
                    }]
                ...
                bottom: {
                    pName: "height",
                    args: [{whichAnim: "first", dir: "bottom", shift: _2b}, {
                        whichAnim: "last",
                        dir: "top",
                        shift: -_2b
                    }]
                ...
                left: {
                    pName: "width",
                    args: [{whichAnim: "first", dir: "left", shift: -_2a}, {
                        whichAnim: "last",
                        dir: "right",
                        shift: _2a
                    }]
        ...
        dojox.fx.flipPage = function (_30) {
            var n = _30.node, _32 = dojo.coords(n, true), x = _32.x, y = _32.y, w = _32.w, h = _32.h,
                _37 = dojo.style(n, "backgroundColor"), _38 = _30.lightColor || "#dddddd", _39 = _30.darkColor,
                _3a = dojo.create("div"), _3b = [], hn = [], dir = _30.dir || "right", pn = {
                    left: ["left", "right", "x", "w"],
                    top: ["top", "bottom", "y", "h"],
                    right: ["left", "left", "x", "w"],
                    bottom: ["top", "top", "y", "h"]
                }, _3f = {right: [1, -1], left: [-1, 1], top: [-1, 1], bottom: [1, -1]};
            dojo.style(_3a, {
                position: "absolute",
                width: w + "px",
                height: h + "px",
            ...
            var hs = [];
            for (var i = 0; i < 2; i++) {
                var r = i % 2, d = r ? pn[dir][1] : dir, wa = r ? "last" : "first", _45 = r ? _37 : _38,
                    _46 = r ? _45 : _30.startColor || n.style.backgroundColor;
                hn[i] = dojo.clone(_3a);
                var _47 = function (x) {
                    return function () {
                        dojo.destroy(hn[x]);
                ...
                _3b.push(dojox.fx.flip({
                    node: hn[i],
                    dir: d,
                    axis: "shortside",
                    depth: _30.depth,
                    duration: _30.duration / 2,
                    shift: _3f[dir][i] * _32[pn[dir][3]] / 2,
                    darkColor: _39,
                    lightColor: _38,
                    whichAnim: wa,
                    endColor: _45
        ...
        dojox.fx.flipGrid = function (_49) {
            var _4a = _49.rows || 4, _4b = _49.cols || 4, _4c = [], _4d = dojo.create("div"), n = _49.node,
                _4f = dojo.coords(n, true), x = _4f.x, y = _4f.y, nw = _4f.w, nh = _4f.h, w = _4f.w / _4b,
                h = _4f.h / _4a, _56 = [];
            dojo.style(_4d, {
                position: "absolute",
                width: w + "px",
            ...
            for (var i = 0; i < _4a; i++) {
                ...
                for (var j = 0; j < _4b; j++) {
                    ...
                    var a = dojox.fx.flipPage({
                        node: hn,
                        dir: d,
                        duration: _49.duration || 900,
                        shift: _5a * w / 2,
                        depth: 0.2,
                        darkColor: _49.darkColor,
                        lightColor: _49.lightColor,
                        startColor: _49.startColor || _49.node.style.backgroundColor
                    }), _64 = function (xn) {
                        return function () {
                            dojo.destroy(xn);
                        };
