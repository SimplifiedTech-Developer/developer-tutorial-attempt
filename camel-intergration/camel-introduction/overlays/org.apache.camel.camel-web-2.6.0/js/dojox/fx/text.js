...
if (!dojo._hasResource["dojox.fx.text"]) {
    ...
    dojox.fx.text._split = function (_1) {
        ...
        var _6 = (_1.text && typeof (_1.text) == "string") ? _1.text : _2.innerHTML, _7 = s.height, _8 = s.width,
            _9 = [];
        ...
        function _12(_13) {
            ...
            if (_13.tagName == "SPAN" && _13.childNodes.length == 1 && _13.firstChild.nodeType == 3) {
                ...
                dojo.style(_13, {
                    padding: 0,
                    margin: 0,
                    top: (_1.crop ? "0px" : _15.t + "px"),
                    left: (_1.crop ? "0px" : _15.l + "px"),
                    display: "inline"
                });
    ...
    dojox.fx.text.explode = function (_18) {
        ...
        _18.pieceAnimation = function (_1b, _1c, _1d, _1e, _1f) {
            ...
            var _2f = dojo.animateProperty({
                ...
                properties: {
                    top: (_18.unhide ? {start: _2d, end: _24} : {start: _24, end: _2d}),
                    left: (_18.unhide ? {start: _2e, end: _25} : {start: _25, end: _2e})
                }
            });
            if (_18.fade) {
                var _30 = dojo.animateProperty({
                    node: _1b,
                    duration: _23,
                    delay: _26,
                    easing: (_18.fadeEasing || dojo.fx.easing.quadOut),
                    properties: {opacity: (_18.unhide ? {start: 0, end: 1} : {end: 0})}
                });
    ...
    dojox.fx.text.disintegrate = function (_33) {
        ...
        _33.pieceAnimation = function (_37, _38, _39, _3a, _3b) {
            ...
            var _44 = dojo.animateProperty({
                ...
                duration: _3f,
                delay: _42,
                easing: (_33.easing || (_33.unhide ? dojo.fx.easing.sinIn : dojo.fx.easing.circIn)),
                properties: _43,
                beforeBegin: (_33.unhide ? function () {
                    if (_33.fade) {
    ...
    dojox.fx.text.blockFadeOut = function (_47) {
        ...
        _47.pieceAnimation = function (_4b, _4c, _4d, _4e, _4f) {
            ...
            var _55 = dojo.animateProperty({
                ...
                duration: _51,
                delay: _54,
                easing: (_47.easing || dojo.fx.easing.sinInOut),
                properties: {opacity: (_47.unhide ? {start: 0, end: 1} : {end: 0})},
                beforeBegin: (_47.unhide ? function () {
    ...
    dojox.fx.text.backspace = function (_58) {
        ...
        _58.pieceAnimation = function (_5d, _5e, _5f, _60, _61) {
            ...
            var _67 = dojo.animateProperty({
                node: _5d,
                duration: 1,
                delay: _5c,
                easing: (_58.easing || dojo.fx.easing.sinInOut),
                properties: {opacity: (_58.unhide ? {start: 0, end: 1} : {end: 0})},
                beforeBegin: _65,
                onEnd: _66
            });
            if (_58.unhide) {
