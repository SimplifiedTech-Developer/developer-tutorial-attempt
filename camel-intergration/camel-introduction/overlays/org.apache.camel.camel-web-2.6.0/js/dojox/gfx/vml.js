    ...
    (function () {
        ...
        dojo.extend(g.Shape, {
            setFill: function (_6) {
                ...
                if (typeof _6 == "object" && "type" in _6) {
                    ...
                    switch (_6.type) {
                        case "linear":
                            ...
                            fo.method = "sigma";
                            fo.type = "gradient";
                            var fc1 = _c ? m.multiplyPoint(_c, f.x1, f.y1) : {x: f.x1, y: f.y1},
                                fc2 = _c ? m.multiplyPoint(_c, f.x2, f.y2) : {x: f.x2, y: f.y2};
                ...
                if (_21) {
                    _21.on = "f";
                    var mt = _20.xx.toFixed(8) + " " + _20.xy.toFixed(8) + " " + _20.yx.toFixed(8) + " " + _20.yy.toFixed(8) + " 0 0",
                        _24 = Math.floor(_20.dx).toFixed() + "px " + Math.floor(_20.dy).toFixed() + "px",
                        s = this.rawNode.style, l = parseFloat(s.left), t = parseFloat(s.top), w = parseFloat(s.width),
        ...
        dojo.declare("dojox.gfx.Path", dojox.gfx.path.Path, {
            ...
            _addArgs: function (_79, _7a, _7b, _7c) {
            ...
            _adjustRelCrd: function (_7f, _80, _81) {
                var n = _80 instanceof Array ? _80 : _80.args, l = n.length, _84 = new Array(l), i = 0, x = _7f.x,
                    y = _7f.y;
                if (typeof x != "number") {
                    _84[0] = x = n[0];
                    _84[1] = y = n[1];
        ...
        dojox.gfx.createSurface = function (_f1, _f2, _f3) {
            ...
            var s = new g.Surface(), p = dojo.byId(_f1), c = s.clipNode = p.ownerDocument.createElement("div"),
