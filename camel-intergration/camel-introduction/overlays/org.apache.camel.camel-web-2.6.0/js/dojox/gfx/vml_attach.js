...
(function () {
    ...
    var _e = function (_15) {
        ...
        if (fo.on && fo.type == "gradient") {
            ...
            if (fo.on && fo.type == "gradientradial") {
                var _16 = dojo.clone(dojox.gfx.defaultRadialGradient), w = parseFloat(r.style.width),
    ...
    var _10 = function (_23) {
        ...
        _23.matrix = dojox.gfx.matrix.normalize({
            xx: sm.xtox,
            xy: sm.ytox,
            yx: sm.xtoy,
            yy: sm.ytoy,
    ...
    var _3 = function (_29) {
        var r = _29.rawNode, _2b = r.outerHTML.match(/arcsize = \"(\d*\.?\d+[%f]?)\"/)[1], _2c = r.style,
            _2d = parseFloat(_2c.width), _2e = parseFloat(_2c.height);
        _2b = (_2b.indexOf("%") >= 0) ? parseFloat(_2b) / 100 : dojox.gfx.vml._parseFloat(_2b);
        _29.shape = dojox.gfx.makeParameters(dojox.gfx.defaultRect, {
            x: parseInt(_2c.left),
            y: parseInt(_2c.top),
            width: _2d,
            height: _2e,
            r: Math.min(_2d, _2e) * _2b
        });
    };
    var _5 = function (_2f) {
        var _30 = _2f.rawNode.style, rx = parseInt(_30.width) / 2, ry = parseInt(_30.height) / 2;
        _2f.shape = dojox.gfx.makeParameters(dojox.gfx.defaultEllipse, {
            cx: parseInt(_30.left) + rx,
            cy: parseInt(_30.top) + ry,
            rx: rx,
            ry: ry
        });
    };
    var _4 = function (_33) {
        ...
        _33.shape = dojox.gfx.makeParameters(dojox.gfx.defaultCircle, {
            cx: parseInt(_34.left) + r,
            cy: parseInt(_34.top) + r,
            r: r
        });
    };
    var _6 = function (_36) {
    ...
    var _7 = function (_39) {
        var _3a = _39.shape = dojo.clone(dojox.gfx.defaultPolyline),
            p = _39.rawNode.path.v.match(dojox.gfx.pathVmlRegExp);
        do {
            if (p.length < 3 || p[0] != "m") {
                break;
            }
    ...
    var _9 = function (_42) {
        var _43 = _42.shape = dojo.clone(dojox.gfx.defaultText), r = _42.rawNode,
    ...
    var _8 = function (_51) {
        var _52 = _51.shape = dojo.clone(dojox.gfx.defaultPath), p = _51.rawNode.path.v.match(dojox.gfx.pathVmlRegExp),
            t = [], _55 = false, map = dojox.gfx.Path._pathVmlToSvgMap;
