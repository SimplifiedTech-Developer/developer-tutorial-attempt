...
if (!dojo._hasResource["dojox.gfx3d.lighting"]) {
    ...
    (function () {
        ...
        dojo.mixin(dojox.gfx3d.lighting, {
            black: function () {
                ...
                for (var i = 0; i < _2e.length; ++i) {
                    var l = _2e[i], h = _1.normalize(_1.add(_1.normalize(l.direction), v)),
                        s = Math.pow(Math.max(0, _1.dot(_2b, h)), 1 / _2d);
                ...
                for (var i = 0; i < _37.length; ++i) {
                    var l = _37[i], r = _1.reflect(_1.scale(-1, _1.normalize(v)), _34),
                        s = Math.pow(Math.max(0, _1.dot(r, _1.normalize(l.direction))), _36);
                    c = _1.addColor(c, _1.scaleColor(s, l.color));
                }
                return _1.saturateColor(c);
            }
        ...
        dojo.declare("dojox.gfx3d.lighting.Model", null, {
            constructor: function (_3d, _3e, _3f, _40) {
                ...
                var _4b = _1.scaleColor(_49.Ka, this.ambient), _4c = _1.saturate(-4 * _1.dot(_48, this.incident)),
                    _4d = _1.scaleColor(_4c * _49.Kd, _1.diffuse(_48, this.lights)),
                    _4e = _1.scaleColor(_4a.a, _1.multiplyColor(_4a, _1.addColor(_4b, _4d)));
                _4e.a = _4a.a;
                ...
                var v = _1.scale(-1, this.incident), _53, _54, _55 = _1.scaleColor(_50.Ka, this.ambient),
                    _56 = _1.saturate(-4 * _1.dot(_4f, this.incident));
                if ("phong" in _50) {
                ...
                var v = _1.scale(-1, this.incident), _5b, _5c, _5d = _1.scaleColor(_58.Ka, this.ambient),
                    _5e = _1.saturate(-4 * _1.dot(_57, this.incident)),
                    _5f = _1.scaleColor(_5e * _58.Kd, _1.diffuse(_57, this.lights));
                if ("phong" in _58) {
                ...
                var _63 = _1.scaleColor(_61.Ka, this.ambient), _64 = _1.saturate(-4 * _1.dot(_60, this.incident)),
                    _65 = _1.scaleColor(_64 * _61.Kd, _1.diffuse(_60, this.lights)),
                    _66 = _1.scaleColor(_62.a, _1.multiplyColor(_62, _1.addColor(_63, _65))),
                    _67 = _1.addColor(this.npr_cool, _1.scaleColor(this.npr_alpha, _66)),
                    _68 = _1.addColor(this.npr_warm, _1.scaleColor(this.npr_beta, _66)),
                    d = (1 + _1.dot(this.incident, _60)) / 2,
                    _66 = _1.scaleColor(this.npr_scale, _1.addColor(_66, _1.mixColor(_67, _68, d)));
                _66.a = _62.a;
