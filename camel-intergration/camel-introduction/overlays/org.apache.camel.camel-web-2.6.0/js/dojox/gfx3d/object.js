...
if (!dojo._hasResource["dojox.gfx3d.object"]) {
    ...
    dojo.declare("dojox.gfx3d.Edges", dojox.gfx3d.Object, {
        constructor: function () {
            ...
            this.object = dojox.gfx.makeParameters(this.object, (_1e instanceof Array) ? {
                points: _1e,
                style: _1f
            } : _1e);
            return this;
    ...
    dojo.declare("dojox.gfx3d.Orbit", dojox.gfx3d.Object, {
        constructor: function () {
            ...
            var _2d = dojo.map(_2b, function (_2e) {
                return {
                    x: this.center.x + this.radius * Math.cos(_2e),
                    y: this.center.y + this.radius * Math.sin(_2e),
                    z: this.center.z
                };
            }, this.object);
    ...
    dojo.declare("dojox.gfx3d.Quads", dojox.gfx3d.Object, {
        constructor: function () {
            ...
            this.object = dojox.gfx.makeParameters(this.object, (_61 instanceof Array) ? {
                points: _61,
                style: _62
            } : _61);
            return this;
    ...
    dojo.declare("dojox.gfx3d.Cylinder", dojox.gfx3d.Object, {
        constructor: function () {
            ...
            var _8e = dojo.map(_8c, function (_8f) {
                return {
                    x: this.center.x + this.radius * Math.cos(_8f),
                    y: this.center.y + this.radius * Math.sin(_8f),
                    z: this.center.z
                };
            }, this.object);
            ...
            var c = this.cache, v = dojox.gfx3d.vector, m = dojox.gfx.matrix, _a4 = [c.center, c.top],
                _a5 = v.substract(c.top, c.center);
            if (v.dotProduct(_a5, this.renderer.lighting.incident) > 0) {
                _a4 = [c.top, c.center];
                _a5 = v.substract(c.center, c.top);
            }
            var _a6 = this.renderer.lighting[this.fillStyle.type](_a5, this.fillStyle.finish, this.fillStyle.color),
            ...
            if (c.rx > 0 && c.ry > 0) {
                this.shape.createEllipse({
                    ...
                    rx: c.rx,
                    ry: c.ry
                }).setFill(_a6).setStroke(this.strokeStyle).applyTransform(m.rotateAt(c.theta, _a4[1]));
            }
        }
    });
