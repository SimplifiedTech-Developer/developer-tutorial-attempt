...
if (!dojo._hasResource["dojox.grid.cells._base"]) {
    ...
    (function () {
        ...
        dojo.declare("dojox.grid.cells.Cell", _4._Base, {
        ...
        dojo.declare("dojox.grid.cells.RowIndex", _4.Cell, {
        ...
        dojo.declare("dojox.grid.cells.Select", _4.Cell, {
            options: null, values: null, returnIndex: -1, constructor: function (_48) {
        ...
        dojo.declare("dojox.grid.cells.AlwaysEdit", _4.Cell, {
            alwaysEditing: true, _formatNode: function (_5a, _5b) {
        ...
        dojo.declare("dojox.grid.cells.Bool", _4.AlwaysEdit, {
            _valueProp: "checked", formatEditing: function (_60, _61) {
