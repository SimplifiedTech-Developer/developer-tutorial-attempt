...
if (!dojo._hasResource["dojox.grid.cells.dijit"]) {
    ...
    (function () {
        ...
        dojo.declare("dojox.grid.cells.ComboBox", _1._Widget, {
            widgetClass: dijit.form.ComboBox, getWidgetProps: function (_21) {
                var _22 = [];
        ...
        dojo.declare("dojox.grid.cells.DateTextBox", _1._Widget, {
            widgetClass: dijit.form.DateTextBox, setValue: function (_2b, _2c) {
                if (this.widget) {
        ...
        dojo.declare("dojox.grid.cells.Editor", _1._Widget, {
            widgetClass: dijit.Editor, getWidgetProps: function (_37) {
