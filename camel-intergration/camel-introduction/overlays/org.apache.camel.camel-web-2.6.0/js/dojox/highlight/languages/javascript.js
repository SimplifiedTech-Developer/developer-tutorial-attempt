...
if (!dojo._hasResource["dojox.highlight.languages.javascript"]) {
    ...
    (function () {
        ...
        dh.languages.javascript = {
            ...
            modes: [_2.C_LINE_COMMENT_MODE, _2.C_BLOCK_COMMENT_MODE, _2.C_NUMBER_MODE, _2.APOS_STRING_MODE, _2.QUOTE_STRING_MODE, _2.BACKSLASH_ESCAPE, {
                className: "regexp",
                begin: "/.*?[^\\\\/]/[gim]*",
                end: "^"
            }, {
            ...
            }, {className: "title", begin: _2.UNDERSCORE_IDENT_RE, end: "^"}, {
                className: "params",
                begin: "\\(",
                end: "\\)",
