...
if (!dojo._hasResource["dojox.image.Badge"]) {
    ...
    dojo.declare("dojox.image.Badge", [dijit._Widget, dijit._Templated], {
        ...
        _enbiggen: function (e) {
            ...
            if (_f) {
                ...
                dojo.animateProperty({
                    node: _f.n,
                    properties: _11,
                    onEnd: dojo.hitch(this, "_loadUnder", _f, _11),
                    easing: this.easing
                }).play();
            }
        },
        _loadUnder: function (_14, _15) {
            ...
            var _18 = (_15.left >= 0);
            var _19 = (_15.top >= 0);
            var c = this.cols, e = idx + (_18 ? -1 : 1), f = idx + (_19 ? -c : c),
                g = (_19 ? (_18 ? e - c : f + 1) : (_18 ? f - 1 : e + c)), bc = this.baseClass;
        ...
        _disenbiggen: function (_21, _22) {
            ...
            dojo.animateProperty({
                node: _21.n,
                properties: dojo.mixin(_22, {width: _cc, height: _cc}),
                onEnd: dojo.hitch(this, "_cycle", _21, _22)
            }).play(5);
        },
