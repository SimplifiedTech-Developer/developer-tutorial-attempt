        ...
        _showThumbs: function (_23) {
            ...
            if (this.isScrollable) {
                ...
                dojox.fx.smoothScroll({
                    ...
                    onEnd: dojo.hitch(this, "_checkLoad", img, _23)
                }).play(10);
            } else {
                if (this.isHorizontal) {
        ...
        _loadImage: function (_36, _37, _38) {
            ...
            dojo.connect(img, "onclick", this, function (evt) {
                dojo.publish(this.getClickTopicName(), [{
                    ...
                    largeUrl: this.imageStore.getValue(_36, this.imageLargeAttr),
                    title: this.imageStore.getValue(_36, this.titleAttr),
                    link: this.imageStore.getValue(_36, this.linkAttr)
                }]);
                return false;
            });
