    ...
    (function () {
        ...
        df.linrec = function (_5, _6, _7, _8) {
            ...
            var _15 = df.keys(_11), _16 = df.keys(_12),
                f = new Function([], "var _x=arguments,_y,_r".concat(_15.length ? "," + _15.join(",") : "", _16.length ? ",_t=_x.callee," + _16.join(",") : t ? ",_t=_x.callee" : "", ";for(;!", cs, ";_x=", bs, "){_y={p:_y,a:_x}}_r=", ts, ";for(;_y;_y=_y.p){_r=", as, "}return _r"));
            if (c) {
                f.c = c;
            }
            if (t) {
