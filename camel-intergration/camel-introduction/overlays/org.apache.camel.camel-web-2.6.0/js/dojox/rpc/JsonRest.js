...
if (!dojo._hasResource["dojox.rpc.JsonRest"]) {
    ...
    (function () {
        ...
        function _4(_5, _6, _7, _8) {
            ...
            return _7 && dojox.json.ref.resolveJson(_7, {
                defaultId: _8,
                index: _2._index,
                timeStamps: _9 && _2._timeStamps,
                time: _9,
                idPrefix: _5.servicePath,
                idAttribute: jr.getIdAttribute(_5),
                schemas: jr.schemas,
                loader: jr._loader,
        ...
        jr = dojox.rpc.JsonRest = {
            conflictDateHeader: "If-Unmodified-Since", commit: function (_a) {
                _a = _a || {};
                var _b = [];
                var _c = {};
                var _d = [];
                    ...
                    if (!(_a.service && (_10 || old) && (_10 || old).__id.indexOf(_a.service.servicePath)) && _f.save) {
                        ...
                        if (_10) {
                            if (old) {
                                ...
                                _b.push({
                                    method: "post",
                                    target: {__id: jr.getServiceAndId(_10.__id).service.servicePath},
                                    content: _10
                                });
                            }
                        } else {
