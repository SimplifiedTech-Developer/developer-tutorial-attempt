...
if (!dojo._hasResource["dojox.rpc.Rest"]) {
    ...
    (function () {
        ...
        _8 = dojox.rpc.Rest = function (_f, _10, _11, _12) {
            ...
            _13._schema = _11;
            _13.cache = {
                serialize: _10 ? ((dojox.json && dojox.json.ref) || dojo).toJson : function (_16) {
                    return _16;
                }
            };
            _13._getRequest = _12 || function (id, _18) {
                var _19 = {
                    url: _f + (dojo.isObject(id) ? "?" + dojo.objectToQuery(id) : id == null ? "" : id),
                    handleAs: _10 ? "json" : "text",
                    contentType: _10 ? "application/json" : "text/plain",
                    sync: dojox.rpc._sync,
                    headers: {Accept: _10 ? "application/json,application/javascript" : "*/*"}
                };
