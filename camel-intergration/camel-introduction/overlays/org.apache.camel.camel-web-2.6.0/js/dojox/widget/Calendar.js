...
if (!dojo._hasResource["dojox.widget.Calendar"]) {
    ...
    dojo.declare("dojox.widget._CalendarBase", [dijit._Widget, dijit._Templated, dijit._Container], {
        ...
        postCreate: function () {
            ...
            var _7 = new Date();
            this.footer.innerHTML = "Today: " + dojo.date.locale.format(_7, {
        ...
        _transitionVert: function (_1d) {
            ...
            var _23 = dojo.animateProperty({
                node: _1e.domNode, properties: {top: _21}, onEnd: function () {
                    dojo.style(_1e.domNode, "visibility", "hidden");
                }
            });
            var _24 = dojo.animateProperty({
                node: _1f.domNode, properties: {top: _22}, onEnd: function () {
                    _1f.onDisplay();
                }
            });
        ...
        _slideTable: function (_25, _26, _27) {
            ...
            var _2b = dojo.animateProperty({
                node: _29, properties: {left: _2a * _26 * -1}, duration: 500, onEnd: function () {
    ...
    dojo.declare("dojox.widget._CalendarView", dijit._Widget, {
        headerClass: "", useHeader: true, cloneClass: function (_35, n, _37) {
