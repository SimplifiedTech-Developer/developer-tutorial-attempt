    ...
    (function (d) {
        ...
        dojo.declare("dojox.widget.ColorPicker", dijit.form._FormWidget, {
            ...
            buildRendering: function () {
                ...
                this._shift = {
                    hue: {x: Math.round(_5.w / 2) - 1, y: Math.round(_5.h / 2) - 1},
                    picker: {x: Math.floor(_4.w / 2), y: Math.floor(_4.h / 2)}
                };
            ...
            _updateColor: function () {
                var _10 = d.style(this.hueCursorNode, "top") + this._shift.hue.y,
                    _11 = d.style(this.cursorNode, "top") + this._shift.picker.y,
                    _12 = d.style(this.cursorNode, "left") + this._shift.picker.x,
                    h = Math.round(360 - (_10 / this.PICKER_HUE_H * 360)),
                    col = dojox.color.fromHsv(h, _12 / this.PICKER_SAT_VAL_W * 100, 100 - (_11 / this.PICKER_SAT_VAL_H * 100));
            ...
            _updatePickerLocations: function (col) {
                var hsv = col.toHsv(),
                    _1d = Math.round(this.PICKER_HUE_H - hsv.h / 360 * this.PICKER_HUE_H - this._shift.hue.y),
                    _1e = Math.round(hsv.s / 100 * this.PICKER_SAT_VAL_W - this._shift.picker.x),
                    _1f = Math.round(this.PICKER_SAT_VAL_H - hsv.v / 100 * this.PICKER_SAT_VAL_H - this._shift.picker.y);
