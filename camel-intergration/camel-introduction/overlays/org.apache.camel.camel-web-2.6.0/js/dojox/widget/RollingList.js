...
if (!dojo._hasResource["dojox.widget.RollingList"]) {
    ...
    dojo.declare("dojox.widget._RollingListPane", [dijit.layout.ContentPane, dijit._Templated], {
        ...
        _doQuery: function () {
            ...
            if (this.items && _14) {
                ...
                if (this.items) {
                    ...
                    this.store.fetch({
                        query: this.query, onComplete: function (_15) {
                            this.items = _15;
                            this.onItems();
                        }, onError: function (e) {
    ...
    dojo.declare("dojox.widget._RollingListGroupPane", [dojox.widget._RollingListPane], {
        ...
        _getMenu: function () {
            var _37 = this;
            var _38 = new dijit.Menu({
                parentMenu: this.parentPane ? this.parentPane._menu : null, onCancel: function (_39) {
                    if (_37.parentPane) {
            ...
            var _82 = dojo.hitch(this, function (_83, _84) {
                ...
                if (this.parentAttr && _85.getFeatures()["dojo.data.api.Identity"] && ((id = this.store.getValue(_83, this.parentAttr)) || id === "")) {
                    ...
                    dojo.forEach(this.childrenAttrs, function (_8b) {
                        ...
                        q[_8b] = _83;
                        _85.fetch({
                            query: q, scope: this, onComplete: function (_8d) {
