...
if (!dojo._hasResource["dojox.widget.Standby"]) {
    ...
    dojo.declare("dojox.widget.Standby", [dijit._Widget, dijit._Templated], {
        ...
        _fadeOut: function () {
            var _16 = this;
            var _17 = dojo.animateProperty({
                node: this._underlayNode, properties: {opacity: {start: 0.75, end: 0}}, onEnd: function () {
                    dojo.style(_16._underlayNode, "display", "none");
                }
            });
            var _18 = dojo.animateProperty({
                node: this._imageNode, properties: {opacity: {start: 1, end: 0}}, onEnd: function () {
